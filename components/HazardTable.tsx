    ...
    return (
      <td
        ...
        className={cn(
          ...
          "h-16 min-h-[4rem]", // Fixed cell height
          bgColorClass,
          textColorClass,
          "font-medium text-sm",
        )}
      ...
      >
        <div className="flex flex-col items-center justify-center h-full">
          <span className="font-semibold leading-tight">
            {labels.length > 0 ? labels[safeValue] || "N/A" : safeValue.toString()}
          </span>
        ...
        >
          <CardContent className="p-0">
            <div className="overflow-x-auto">
              {/* Fixed table container with consistent spacing */}
              <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                <div className="min-h-[400px] min-w-[1200px]">
                  <table className="w-full border-collapse table-fixed min-w-[1200px] transform-gpu">
                    <thead className="sticky top-0 z-10">
                      <tr className="bg-gray-50">
                        <th className="w-64 p-4 border border-gray-200 text-left font-bold text-gray-800 bg-gray-100">
                      ...
                      <tr className="bg-gray-50">
                        ...
                        <th className="w-28 p-3 border border-gray-200 text-center font-semibold text-blue-800 bg-blue-50">
                          Probability
                        </th>
                        <th className="w-24 p-3 border border-gray-200 text-center font-semibold text-blue-800 bg-blue-50">
                          Alerts
                        </th>
                        <th className="w-28 p-3 border border-gray-200 text-center font-semibold text-blue-800 bg-blue-50">
                          Activations
                        </th>
                        <th className="w-24 p-3 border border-gray-200 text-center font-semibold text-orange-800 bg-orange-50">
                          Human
                        </th>
                        <th className="w-24 p-3 border border-gray-200 text-center font-semibold text-orange-800 bg-orange-50">
                          Property
                        ...
                        <th className="w-28 p-3 border border-gray-200 text-center font-semibold text-green-800 bg-green-50">
                          Preparedness
                        </th>
                        <th className="w-24 p-3 border border-gray-200 text-center font-semibold text-green-800 bg-green-50">
                          Internal
                        </th>
                        <th className="w-24 p-3 border border-gray-200 text-center font-semibold text-green-800 bg-green-50">
                          External
                    ...
                    <tbody>
                      {hazards.map((hazard, index) => (
                        <tr
                          key={hazard.id}
                          className={cn(
                            "transition-colors duration-150 h-16", // Fixed row height
